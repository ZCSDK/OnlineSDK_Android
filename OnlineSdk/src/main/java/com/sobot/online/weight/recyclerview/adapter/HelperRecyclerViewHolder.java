...
public class HelperRecyclerViewHolder extends BaseRecyclerViewHolder implements ViewHelper.RecyclerView<HelperRecyclerViewHolder> {
    ...
    public HelperRecyclerViewHolder setRichText(int viewId, String value, boolean isLeft) {
        ...
        HtmlTools.getInstance(SobotUtils.getApp()).setRichText(view, value, isLeft ? SobotResourceUtils.getResColorId(SobotUtils.getApp(), "sobot_color_link") : SobotResourceUtils.getResColorId(SobotUtils.getApp(), "sobot_color_rlink"));
        return this;
    }
