...
import com.sobot.onlinecommon.frame.http.HttpUtils;
import com.sobot.onlinecommon.frame.http.db.SobotDownloadManager;
import com.sobot.onlinecommon.frame.http.download.SobotDownload;
import com.sobot.onlinecommon.frame.http.download.SobotDownloadListener;
...
public class SobotVideoActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(SobotResourceUtils.getResLayoutId(getApplicationContext(), "sobot_activity_video"));
        mVideoView = (StVideoView) findViewById(SobotResourceUtils.getResId(getApplicationContext(), "sobot_videoview"));
        st_tv_play = (TextView) findViewById(SobotResourceUtils.getResId(getApplicationContext(), "st_tv_play"));
        st_iv_pic = (ImageView) findViewById(SobotResourceUtils.getResId(getApplicationContext(), "st_iv_pic"));
        progressBar = (ProgressBar) findViewById(SobotResourceUtils.getResId(getApplicationContext(), "sobot_msgProgressBar"));
